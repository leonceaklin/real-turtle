...
describe("A turtle instance can be created", () => {
  test("in normal mode", () => {
    const turtle = new RealTurtle();
    expect(turtle).toBeInstanceOf(RealTurtle);
  });

  test("in async mode", () => {
    const turtle = new RealTurtle(undefined, { async: true });
    expect(turtle).toBeInstanceOf(RealTurtle);
  });

  test("with a string passed as canvas query selector", () => {
    const canvas = createCanvas();
    const turtle = new RealTurtle("#testCanvas");
    expect(turtle).toBeInstanceOf(RealTurtle);
  });

  test("with a wrapper element", () => {
    ...
    const turtle = new RealTurtle(wrapper);
    expect(turtle).toBeInstanceOf(RealTurtle);
  });
});
...
function createNormalTurtle() {
  const turtle = new RealTurtle(createCanvas(), {
    async: false,
    image: false,
    state: initialState,
  });
...
describe("The turtle can", () => {
  test("move forward", async () => {
    const turtle = createNormalTurtle();
    ...
    const path = turtle.ctx.__getPath();
  ...
  test("use eval", async () => {
    const turtle = createSlowNormalTurtle();
...
describe("The turtle passes other functional tests like", () => {
  ...
  test("solving multiple drawing tasks in async mode", async () => {
    const turtle = createAsyncTurtle();
